const game = {
    ...
    players : [['Neuer','Pavard','Martinez','Alaba','Kimmich','Goretzka','Coman','Muller','Gnarby','Lewandowski'],['Burki','Schulz','Hummels','Akanji','Hakimi','Weigl','Witsel','Hazard','Brandt','Sancho','Gotze']],
    score: '4:0',
...
let players1Final = player1.slice()
